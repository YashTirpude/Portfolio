...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: "A full-stack web application built with React and Node.js",
    longDescription:
      "Streamline your job search with this full-stack Job Application Tracker, built using React and Node.js. The application allows users to manage their job applications efficiently, featuring real-time status updates, and extensive data filtration, resume uploads, and infinite scrolling for seamless navigation.",
